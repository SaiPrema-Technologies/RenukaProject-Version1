...
public class GetStockInfoPage extends JFrame implements ActionListener{
	private JLabel CompanyName;
	private JButton Logoutbtn,Backbtn,MainMenubtn;
	//private JButton Backbtn;
	//private JButton MainMenubtn;
	public GetStockInfoPage(String prodname){
        ...
        String sql = "SELECT Product_name,Date,Invoice_no,Opening_stock,Purchase,Sale,Closing_stock,Price_per_unit FROM stock ";
        String sql1 = "SELECT Product_name,Date,Invoice_no,Opening_stock,Purchase,Sale,Closing_stock,Price_per_unit FROM stock where Product_name=?";
        ////////////
        ...
        try {Connection connection = (Connection) DriverManager.getConnection( url, userid, password );
        		...
        		ResultSet rs = verifyUsr.executeQuery(sql);
        		{
        		...
        		verifyProd.setString(1, prodname);
        		
        		ResultSet rs1 = verifyProd.executeQuery();
        		{
            ...
            //columnNamesVector.setPreferredWidth(100);
